...
const FileoperationAddCustomersSpecialPrice = ({ 
  onSuccess, 
  onError, 
  onRefresh, 
  onDataChange,
  ...
  const handleFileUpload = async (acceptedFiles) => {
    ...
    try {
      ...
      formData.append('operation_type', 'customers_special_price');

      const response = await axios.post(
        `${app_url}/api/fileoperation/validate-customers-special-price`,
        formData,
        {
          headers: {
      ...
      if (response.data.success) {
        ...
        console.log('Customers Special Price: Setting unsaved data to true after file upload');
  ...
  const handleImport = async () => {
    ...
    try {
      const response = await axios.post(
        `${app_url}/api/fileoperation/import-customers-special-price`,
        {
      ...
      if (response.data.success) {
        if (onSuccess) {
          onSuccess('Customers special prices imported successfully');
        }
        
        // Clear global unsaved data flag
        console.log('Customers Special Price: Setting unsaved data to false after successful import');
  ...
  const handleExportInvalidRows = () => {
    ...
    a.href = url;
    a.download = 'invalid_customers_special_price.csv';
    a.click();
  ...
  const handleUploadNewFile = () => {
    ...
    // Clear global unsaved data flag
    console.log('Customers Special Price: Setting unsaved data to false after upload new file');
    setGlobalUnsavedData(false);
    if (onDataChange) {
      onDataChange(false);
    }
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Import Customers Special Price</h2>
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-4 mb-2">
              ...
              <span className="text-blue-600 text-sm font-medium">Min. Qty</span>
              <span className="text-blue-600 text-sm font-medium">Price</span>
            </div>
            <div className="text-sm text-blue-600">
              <strong>Validation:</strong> Customer vs. Customers; Brand/Code vs. Products
            </div>
            <div className="text-sm text-gray-600 mt-2">
              <strong>Purpose:</strong> Sets custom pricing for specific customers.
            </div>
          </div>
  ...
  return (
    <div className="bg-white">
      <div className="p-6">
        <div className="mb-6">
          <h3 className="text-lg font-medium mb-1">Add Customers Special Price</h3>
          <p className="text-sm text-gray-600 mb-4">Import customer-specific pricing data</p>
          
          {/* Required Columns */}
          <div className="mb-6">
            <div className="text-sm font-medium text-gray-700 mb-2">Required Columns</div>
            <div className="flex gap-4 mb-2">
              <a href="#" className="text-blue-600 hover:text-blue-800 text-sm">Customer</a>
              ...
              <a href="#" className="text-blue-600 hover:text-blue-800 text-sm">Min. Qty</a>
              <a href="#" className="text-blue-600 hover:text-blue-800 text-sm">Price</a>
            </div>
            <div className="text-sm text-blue-600">
              <strong>Validation:</strong> Customer vs. Customers; Brand/Code vs. Products
            </div>
...
export default FileoperationAddCustomersSpecialPrice;
