...
description : yup.string().required(t('The Description field is required')), 
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Packinglistboxitem."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Packinglistboxitem deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deletePackinglistboxitem(id);
        setToastMessage(t("Packinglistboxitem deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Packinglistboxitem."));
    }
    basicStickyNotification.current?.showToast();
  };    
