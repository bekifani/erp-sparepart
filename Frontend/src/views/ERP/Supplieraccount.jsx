...
additional_note : yup.string().required(t('The Additional Note field is required')), 
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Supplieraccount."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Supplieraccount deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deleteSupplieraccount(id);
        setToastMessage(t("Supplieraccount deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Supplieraccount."));
    }
    basicStickyNotification.current?.showToast();
  };    
