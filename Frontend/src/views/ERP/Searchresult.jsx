  ...
  const getMiniDisplay = (url) => {
    ...
    try {
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error creating Searchresult");
    ...
    try {
      console.log('🟡 Updating searchresult with data:', data);
      const response = await updateSearchresult(data);
      console.log('🟡 Update searchresult response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error updating Searchresult");
      ...
      console.error('🔴 Update searchresult error:', error);
      let errorMessage = t("Error updating Searchresult");
    ...
    try {
      console.log('🔴 Deleting searchresult with id:', id);
      const response = await deleteSearchresult(id);
      console.log('🔴 Delete searchresult response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        if (response?.error?.data?.data?.errors) {
          ...
          setToastMessage(`${t("Error deleting Searchresult")}: ${errorMsg}`);
        }
        console.error('🔴 Delete failed with response:', response);
      }
    } catch (error) {
      console.error('🔴 Delete searchresult error:', error);
      let errorMessage = t("Error deleting Searchresult");
