...
import users, { User } from "@/fakers/users";
import clsx from "clsx";
import SimpleBar from "simplebar";
import { Menu } from "@/components/Base/Headless";
import QuickSearch from "@/components/QuickSearch";
import SwitchAccount from "@/components/SwitchAccount";
import NotificationsPanel from "@/components/NotificationsPanel/notificatoin.jsx";
...
function Main() {  
  ...
  const user_data: any = useSelector((state: RootState) => state.auth.user)
  const media_url : any = useSelector((state:RootState) => state.auth.media_url)
  ...
  const sideMenu = () => nestedMenu(sideMenuStore, location, user?.permissions ? user?.permissions : []);
    ...
    >
      ...
      >
        ...
        >
          <div
            className={clsx([
              "flex-none pt-3 xl:flex items-center z-10 px-5 h-[65px] w-[275px] overflow-hidden relative duration-300 group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px]",
            ])}
          >
            <a
              href=""
                  ...
                  <li key={menuKey}>
                    <a
                      ...
                      onClick={(event: React.MouseEvent) => {
                        ...
                        setActiveMobileMenu(menu.pathname ? false :  true);
                      }}
                    >
                      <Lucide
                        icon={menu.icon}
                            ...
                            <li key={subMenuKey}>
                              <a
                                ...
                                onClick={(event: React.MouseEvent) => {
                                  ...
                                  setFormattedMenu([...formattedMenu]);
                                  setActiveMobileMenu(subMenu.pathname ? false :  true);
                                }}
                              >
                                <Lucide
                                  icon={subMenu.icon}
