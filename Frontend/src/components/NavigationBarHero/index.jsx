...
const HeroNavigation = () => {
  ...
  return (
    <nav className={`z-[9999] fixed w-full transition-all duration-300 translate-y-0`}>
      <div className="w-auto mx-auto px-14 pt-5 sm:px-6 lg:px-8">
        <div className="flex justify-between md:justify-center gap-16 h-16">
      ...
      {/* Mobile menu */}
      <div className={`${isOpen ? 'block' : 'hidden'} md:hidden dark:bg-gray-900/75 bg-gray-100/75 backdrop-blur-md z-[9999]`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <Link to="/" className="block px-3 py-2 rounded-md text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800">
            Home
          </Link>
          <a href="#about" className="block px-3 py-2 rounded-md text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800">
            About
          </a>
          <Link to="/business-sectors" className="block px-3 py-2 rounded-md text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800">
            Sectors
          </Link>
          <Link to="/contact" className="block px-3 py-2 rounded-md text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800">
            Contact
          </Link>
          {!isAutenticated ? (
