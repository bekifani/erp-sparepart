 ...
 const [
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Basketfile."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Basketfile deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deleteBasketfile(id);
        setToastMessage(t("Basketfile deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Basketfile."));
    }
    basicStickyNotification.current?.showToast();
  };    
