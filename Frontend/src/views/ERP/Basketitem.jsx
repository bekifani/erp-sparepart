  ...
  const getMiniDisplay = (url) => {
    ...
    try {
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error creating Basketitem");
    ...
    try {
      console.log('🟡 Updating basketitem with data:', data);
      const response = await updateBasketitem(data);
      console.log('🟡 Update basketitem response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error updating Basketitem");
      ...
      console.error('🔴 Update basketitem error:', error);
      let errorMessage = t("Error updating Basketitem");
    ...
    try {
      console.log('🔴 Deleting basketitem with id:', id);
      const response = await deleteBasketitem(id);
      console.log('🔴 Delete basketitem response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        if (response?.error?.data?.data?.errors) {
          ...
          setToastMessage(`${t("Error deleting Basketitem")}: ${errorMsg}`);
        }
        console.error('🔴 Delete failed with response:', response);
      }
    } catch (error) {
      console.error('🔴 Delete basketitem error:', error);
      let errorMessage = t("Error deleting Basketitem");
