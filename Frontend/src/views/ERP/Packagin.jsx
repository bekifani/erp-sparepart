...
customer_note : yup.string().required(t('The Customer Note field is required')), 
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Packagin."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Packagin deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deletePackagin(id);
        setToastMessage(t("Packagin deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Packagin."));
    }
    basicStickyNotification.current?.showToast();
  };    
