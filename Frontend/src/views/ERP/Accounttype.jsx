...
status : yup.string().required(t('The Status field is required')), 
  ...
  const onCreate = async (data) => {
    ...
    try {
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error creating Accounttype");
  ...
  const onUpdate = async (data) => {
    try {
      console.log('🟡 Updating accounttype with data:', data);
      const response = await updateAccounttype(data);
      console.log('🟡 Update accounttype response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error updating Accounttype");
  ...
  const onDelete = async () => {
    ...
    try {
      console.log('🔴 Deleting accounttype with id:', id);
      const response = await deleteAccounttype(id);
      console.log('🔴 Delete accounttype response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        if (response?.error?.data?.data?.errors) {
          ...
          setToastMessage(`${t("Error deleting Accounttype")}: ${errorMsg}`);
        }
        console.error('🔴 Delete failed with response:', response);
      }
    } catch (error) {
      console.error('🔴 Delete accounttype error:', error);
      let errorMessage = t("Error deleting Accounttype");
