...
customer_id : yup.string().required(t('The Customer Id field is required')), 
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Supplierpricingrulecustomer."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Supplierpricingrulecustomer deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deleteSupplierpricingrulecustomer(id);
        setToastMessage(t("Supplierpricingrulecustomer deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Supplierpricingrulecustomer."));
    }
    basicStickyNotification.current?.showToast();
  };    
