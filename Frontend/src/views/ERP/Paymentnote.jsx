...
note_az : yup.string().required(t('The Note Az field is required')), 
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Paymentnote."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Paymentnote deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deletePaymentnote(id);
        setToastMessage(t("Paymentnote deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Paymentnote."));
    }
    basicStickyNotification.current?.showToast();
  };    
