...
additional_note : yup.string().required(t('The Additional Note field is required')), 
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Customerinvoiceitem."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Customerinvoiceitem deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deleteCustomerinvoiceitem(id);
        setToastMessage(t("Customerinvoiceitem deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Customerinvoiceitem."));
    }
    basicStickyNotification.current?.showToast();
  };    
