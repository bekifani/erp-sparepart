  ...
  const getMiniDisplay = (url) => {
    ...
    try {
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error creating Basket");
    ...
    try {
      console.log('🟡 Updating basket with data:', data);
      const response = await updateBasket(data);
      console.log('🟡 Update basket response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error updating Basket");
    ...
    try {
      console.log('🔴 Deleting basket with id:', id);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        if (response?.error?.data?.data?.errors) {
          ...
          setToastMessage(`${t("Error deleting Basket")}: ${errorMsg}`);
        }
        console.error('🔴 Delete failed with response:', response);
      }
    } catch (error) {
      console.error('🔴 Delete basket error:', error);
      let errorMessage = t("Error deleting Basket");
