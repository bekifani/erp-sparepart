...
is_active : yup.string().required(t('The Is Active field is required')), 
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Warehouse."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Warehouse deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deleteWarehouse(id);
        setToastMessage(t("Warehouse deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Warehouse."));
    }
    basicStickyNotification.current?.showToast();
  };    
