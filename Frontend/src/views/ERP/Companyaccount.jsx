...
additional_note : yup.string().required(t('The Additional Note field is required')), 
  ...
  const onCreate = async (data) => {
    try {
      ...
      setToastMessage(t("Error creating Companyaccount."));
    }
  ...
  const onUpdate = async (data) => {
    ...
    try {
      ...
      setShowUpdateModal(true)
      setToastMessage(t('Companyaccount deletion failed'));
    }
    basicStickyNotification.current?.showToast();
  };
  ...
  const onDelete = async () => {
    ...
    try {
        const response = deleteCompanyaccount(id);
        setToastMessage(t("Companyaccount deleted successfully."));
        setRefetch(true);
      }
    catch (error) {
      setToastMessage(t("Error deleting Companyaccount."));
    }
    basicStickyNotification.current?.showToast();
  };    
