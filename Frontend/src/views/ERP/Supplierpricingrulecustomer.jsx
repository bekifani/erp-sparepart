...
customer_id : yup.string().required(t('The Customer Id field is required')), 
  ...
  const getMiniDisplay = (url) => {
    ...
    try {
      console.log('🟡 Updating supplierpricingrulecustomer with data:', data);
      const response = await updateSupplierpricingrulecustomer(data);
      console.log('🟡 Update supplierpricingrulecustomer response:', response);
      ...
      console.error('🔴 Update supplierpricingrulecustomer error:', error);
      let errorMessage = t("Error updating Supplierpricingrulecustomer");
    ...
    try {
      console.log('🔴 Deleting supplierpricingrulecustomer with id:', id);
      const response = await deleteSupplierpricingrulecustomer(id);
      console.log('🔴 Delete supplierpricingrulecustomer response:', response);
      ...
      console.error('🔴 Delete supplierpricingrulecustomer error:', error);
