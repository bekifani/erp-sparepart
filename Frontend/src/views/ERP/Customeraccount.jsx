  ...
  const getMiniDisplay = (url) => {
    ...
    try {
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error creating Customeraccount");
    ...
    try {
      console.log('🟡 Updating customeraccount with data:', data);
      const response = await updateCustomeraccount(data);
      console.log('🟡 Update customeraccount response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error updating Customeraccount");
    ...
    try {
      console.log('🔴 Deleting customeraccount with id:', id);
      const response = await deleteCustomeraccount(id);
      console.log('🔴 Delete customeraccount response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        if (response?.error?.data?.data?.errors) {
          ...
          setToastMessage(`${t("Error deleting Customeraccount")}: ${errorMsg}`);
        }
        console.error('🔴 Delete failed with response:', response);
      }
    } catch (error) {
      console.error('🔴 Delete customeraccount error:', error);
      let errorMessage = t("Error deleting Customeraccount");
