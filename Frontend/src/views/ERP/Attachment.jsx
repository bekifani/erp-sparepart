  ...
  const getMiniDisplay = (url) => {
    ...
    try {
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error creating Attachment");
    ...
    try {
      console.log('🟡 Updating attachment with data:', data);
      const response = await updateAttachment(data);
      console.log('🟡 Update attachment response:', response);
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        let errorMessage = t("Error updating Attachment");
    ...
    try {
      ...
      if (response && (response.success === true || response.data?.success === true)) {
        ...
        if (response?.error?.data?.data?.errors) {
          ...
          setToastMessage(`${t("Error deleting Attachment")}: ${errorMsg}`);
        }
        console.error('🔴 Delete failed with response:', response);
      }
    } catch (error) {
      console.error('🔴 Delete attachment error:', error);
      let errorMessage = t("Error deleting Attachment");
