...
function TechnicalImages() {
  ...
  // Fetch technical images from API
  const fetchTechnicalImages = async () => {
    try {
      setLoading(true);
      console.log('🔄 Fetching technical images from:', `${app_url}/api/images/technical-images`);
      console.log('📋 Request headers:', {
        'Authorization': `Bearer ${localStorage.getItem('token') ? '***TOKEN***' : 'NO_TOKEN'}`,
        'Content-Type': 'application/json',
      });
      
      const response = await fetch(`${app_url}/api/images/technical-images`, {
        headers: {
      ...
      if (response.ok) {
        ...
        console.log('✅ Technical images data received:', data);
        console.log('📊 Number of images:', data.length);
        setImages(data);
        setFilteredImages(data);
      } else {
        const errorText = await response.text();
        console.error('❌ Failed to fetch technical images');
      ...
      console.error('💥 Network/JS Error fetching technical images:', error);
        ...
        <div className="col-span-12 lg:col-span-12">
          ...
          {loading && (
            <div className="flex justify-center items-center py-20">
              ...
              <span className="ml-2">{t("Loading technical images...")}</span>
            </div>
          )}
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="text-xs text-gray-600 space-y-1">
                      ...
                      <p><span className="font-medium">Type:</span> Technical Image</p>
          ...
          {!loading && filteredImages.length === 0 && (
            <div className="text-center py-20">
              <Lucide icon="FileImage" className="w-16 h-16 mx-auto text-gray-400 mb-4" />
              <p className="text-gray-500">
                {searchTerm ? t("No technical images found matching your search.") : t("No technical images available.")}
              </p>
            </div>
          )}
        </div>
              ...
              <>
                ...
                <div className="col-span-12 lg:col-span-6 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">Technical Image</p>
                  </div>
                  <div>
