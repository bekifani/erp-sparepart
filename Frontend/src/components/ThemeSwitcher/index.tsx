          ...
          <Slideover.Description className="p-0">
            <div className="flex flex-col">
              {/* <div className="px-8 pt-6 pb-8">
                <div className="text-base font-medium">{t('Templates')}</div>
                <div className="text-slate-500 mt-0.5">{t('Choose your templates')}</div>
              ...
              {/* <div className="px-8 pt-6 pb-8">
                <div className="text-base font-medium">{t('Color Schemes')}</div>
                <div className="text-slate-500 mt-0.5">
                    {t('Choose your color schemes')}
                </div>
              ...
              <div className="px-8 pt-6 pb-4">
                ...
                <div className="text-slate-500 mt-0.5">{t('Choose your appearance')}</div>
                <div className="grid grid-cols-3 gap-4 mt-5">
                  <div>
                    ...
                    <div className="mt-2.5 capitalize text-center text-xs">{t('Light Mode')}</div>
                  </div>
                  <div>
                    <div
                    ...
                    <div className="mt-2.5 capitalize text-center text-xs">{t('Dark Mode')}</div>
                  </div>
                </div>
              </div>
